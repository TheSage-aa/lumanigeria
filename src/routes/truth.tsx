...
export const Route = createFileRoute("/truth")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Status-neutral HIV stories, research, and myth-busting written for Nigerian university students." },
      { property: "og:title", content: "Campus Truth Series — LUMA" },
      { property: "og:description", content: "Stories, research, and myth-busting on HIV for Nigerian campuses." },
    ],
  }),
  component: () => {
