  ...
  head: () => ({
    meta: [
      { title: "Our Work — LUMA" },
      {
        name: "description",
        content:
          "LUMA's research, advocacy, and community programmes across Nigerian universities.",
      },
      { property: "og:title", content: "Our Work — LUMA" },
      {
        property: "og:description",
        content:
          "What LUMA is building across Nigerian campuses: research, advocacy, and community.",
      },
    ],
  }),
  component: WorkRoute,
